...
To view AIMET's Tensorflow, ONNX, Keras documentation, please visit our `AIMET v1 Documentation <https://quic.github.io/aimet-pages/releases/latest/user_guide/index.html>`_ page.

AI Model Efficiency Toolkit (AIMET) is a software toolkit that enables users to quantize ML models.
The resulting models returned by AIMET can be further trained (or fine-tuned)
to dramatically improve accuracy lost due to quantization and compression.

AIMET PyTorch is designed to work generically on any user-provided PyTorch model. Please follow the links on this page to see
AIMET PyTorch tutorials, examples, features, and APIs.
