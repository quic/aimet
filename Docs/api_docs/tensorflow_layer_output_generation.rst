...
.. _api-tensorflow-layer-output-generation:
...
.. autoclass:: aimet_tensorflow.layer_output_utils.LayerOutputUtil

|

**The following API can be used to Generate Layer Outputs**

.. automethod:: aimet_tensorflow.layer_output_utils.LayerOutputUtil.generate_layer_outputs
